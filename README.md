...
An Obsidian plugin that lets you tie notes to places on a map. Works entirely
offline, on desktop and mobile.
...
- Country outlines from [world-atlas](https://github.com/topojson/world-atlas),
  derived from [Natural Earth](https://www.naturalearthdata.com/) (public domain).
- Country names and codes, and populated places with more than 15,000
  inhabitants, from [GeoNames](https://www.geonames.org/), licensed under
